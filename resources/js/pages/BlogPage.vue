        ...
        <section class="bg-white">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                    <h2
                        class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-primary-color"
                    >
                        Our Blog
                    </h2>
                    <p
                ...
                <div v-for="blog in blogData" :key="blog" class="p-3">
                    <div class="grid gap-8 lg:grid-cols-2">
                        <article
                            class="p-6 bg-white rounded-lg border border-gray-200 hover:shadow-md border-primary-color"
                        >
                            <div
                            ...
                            >
                                ...
                                >
                                    <seticon class="px-1" icon="newspaper" />
                                    Tutorial
                                </span>
                                <span class="text-sm">14 days ago</span>
                            </div>
                            <h2
                                class="mb-2 text-2xl font-bold tracking-tight text-primary-color"
                            >
